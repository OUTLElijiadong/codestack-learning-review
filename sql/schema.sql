...
CREATE DATABASE IF NOT EXISTS review_db DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE review_db;
...
-- 3. 错题标签表（学生个人私有标签）
-- ---------------------------------------------------------------------------
DROP TABLE IF EXISTS mistake_tag;
...
-- ---------------------------------------------------------------------------
DROP TABLE IF EXISTS mistake_tag_rel;
CREATE TABLE mistake_tag_rel (
...
-- ---------------------------------------------------------------------------
DROP TABLE IF EXISTS study_time_log;
